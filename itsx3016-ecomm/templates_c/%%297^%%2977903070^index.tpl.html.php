<?php /* Smarty version 2.6.0, created on 2017-07-19 15:47:09
         compiled from ./templates/tmpl1/admin/index.tpl.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'capitalize', './templates/tmpl1/admin/index.tpl.html', 33, false),array('modifier', 'replace', './templates/tmpl1/admin/index.tpl.html', 73, false),)), $this); ?>
<html>
<head>
...
<tr style="background: white url(images/backend/header_bg_downup.gif) repeat-x; background-position: bottom;height:1%;width:100%;text-align:center;">
 ...
 <td width="30%" align="right" valign="middle">
	...
	<?php if ($this->_tpl_vars['totals'] != ""): ?>
     ...
     <form name="download" method="post" action="download_csv.php">
     <p><label><input type="submit" name="download" id="button" value="Download CSV"></label></p>
     </form>
	<?php else: ?>
